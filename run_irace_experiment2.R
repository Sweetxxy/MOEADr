...
scenario$seed          <- 54321 # Seed for the experiment
...
## Running the experiment
sink("./Experiments/Irace tuning/irace-output_experiment2.txt")
irace.output <- irace::irace(scenario, parameters)
sink()
saveRDS(irace.output, "./Experiments/Irace tuning/experiment2_RESULTS.rds")
